...
import TangoExcitedRight from '@/assets/tangoPhotos/TangoExcitedRight.png'
import { PlayAudio } from './PlayAudio'

export function HomeTangoText({text, audio}: {text: string, audio: string}) {
    ...
    <div>
      ...
      >
        <button className="text-4xl" onClick={() => setOpen(true)}>
          <img src={TangoExcitedRight} alt="Tango Talk" className="w-[35vw]" />
        </button>
      </Popover>
      <PlayAudio src={audio} />
    </div>
